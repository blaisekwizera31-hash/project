...
const iconMap = [MessageSquare, Mic, Globe, FileText, Users, Clock, Lock, Shield];
const colorMap = ["bg-accent", "bg-secondary", "bg-primary", "bg-accent", "bg-secondary", "bg-primary", "bg-accent", "bg-secondary"];
