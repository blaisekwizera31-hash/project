      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.features}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.howItWorks}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.aiAssistant}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.findLawyer}</a></li>
            </ul>
          </div>

          {/* For Users */}
          <div>
            <h4 className="font-semibold mb-4">{t.forUsers}</h4>
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.citizensPortal}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.lawyersPortal}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.courtOfficials}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.adminDashboard}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.privacyPolicy}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.termsOfService}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.dataProtection}</a></li>
              <li><a href="#" className="hover:text-primary-foreground transition-colors">{t.links.accessibility}</a></li>
            </ul>
          </div>
        </div>
