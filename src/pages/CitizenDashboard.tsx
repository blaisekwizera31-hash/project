  ...
  const recentCases = [
    {
      id: "CASE-2024-001",
      title: "Property Dispute Resolution",
      status: t.caseStatuses.inProgress,
      statusColor: "bg-amber-500",
      date: "Jan 10, 2024",
    },
    {
      id: "CASE-2024-002",
      title: "Employment Contract Review",
      status: t.caseStatuses.completed,
      statusColor: "bg-secondary",
      date: "Jan 5, 2024",
    },
    {
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h1 className="text-2xl font-display font-bold mb-1">{t.welcome}, Amahoro!</h1>
          ...
          >
            {[
              { icon: Plus, label: t.quickActions.submitCase, color: "gradient-gold text-primary", href: "/submit-case" },
              { icon: MessageSquare, label: t.quickActions.askAI, color: "bg-secondary text-secondary-foreground", href: "/ai-assistant" },
              { icon: Briefcase, label: t.quickActions.findLawyer, color: "bg-primary text-primary-foreground", href: "/find-lawyer" },
              { icon: Calendar, label: t.quickActions.bookConsultation, color: "bg-accent text-accent-foreground", href: "/appointments" },
            ].map((action) => (
              <Link
                key={action.label}
                to={action.href}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="bg-card rounded-2xl border border-border shadow-soft">
                <div className="flex items-center justify-between p-5 border-b border-border">
                  <h2 className="font-semibold">{t.recentCases}</h2>
                  <Button variant="ghost" size="sm" className="text-accent">
                    {commonT.viewAll} <ChevronRight className="w-4 h-4 ml-1" />
                  </Button>
                </div>
                <div className="divide-y divide-border">
                  {recentCases.map((caseItem) => (
                ...
                <div className="gradient-hero p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">{t.onlineStatus}</p>
                    </div>
                  </div>
                </div>
                <div className="p-4">
                  <div className="relative">
                    <Input placeholder={t.askQuestion} className="pr-20" />
                    <div className="absolute right-1 top-1/2 -translate-y-1/2 flex gap-1">
                      <Button variant="ghost" size="icon" className="h-8 w-8">
                        <Mic className="w-4 h-4" />
                      </Button>
